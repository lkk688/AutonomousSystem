...
import os
import yaml
from natsort import natsorted #natsorted identifies numbers anywhere in a string and sorts them naturally
#ref https://github.com/klintan/ros2_video_streamer/blob/master/camera_simulator/camera_simulator.py
...
class ImagePublisher(Node):
    ...
    def __init__(self, **kwargs):
        ...
        self.timer_period = self.declare_parameter("timer_period", 0.1).value
        ...
        self.publisher_ = self.create_publisher(Image, image_topic_, 10)
